...
void Engine::printStats() {
	...
	printf("%%%%%%mzn-stat: propagations=%lld\n", propagations);
   	printf("%%%%%%mzn-stat: ewma_propagations=%.3f\n", ewma_propagations);
